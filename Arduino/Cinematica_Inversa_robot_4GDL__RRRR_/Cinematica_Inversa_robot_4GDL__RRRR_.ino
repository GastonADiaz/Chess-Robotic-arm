...
CoordenadasGlobales coordenadas_del_tablero[64]= {            // Creo una instancia de 'CoordenadasGlobales' llamada 'coordenadas_del_tablero' con un tamaño de 64 casillas y la inicializo.
    ...
    {85, 216, 22, 90}, {58, 212, 18, 90}, {28, 214, 16, 90}, {8, 215, 15, 90}, {-12, 210, 17, 90}, {-42, 208, 18, 90}, {-65, 212, 20, 90}, {-96, 214, 22, 90},      // A2 - H2
    {83, 180, 12, 90}, {56, 180, 12, 90}, {30, 180, 16, 90}, {8, 180, 15, 90}, {-15, 180, 16, 90}, {-43, 178, 15, 90}, {-65, 178, 14, 90}, {-93, 178, 15, 90},      // A3 - H3
    {82, 155, 12, 90}, {56, 158, 14, 90}, {32, 155, 14, 90}, {7, 155, 14, 90}, {-15, 155, 14, 90}, {-42, 155, 14, 90}, {-65, 155, 14, 90}, {-90, 151, 15, 90},      // A4 - H4
    {80, 132, 13, 90}, {54, 132, 11, 90}, {28, 128, 10, 90}, {6, 129, 10, 90}, {-13, 132, 14, 90}, {-42, 131, 13, 90}, {-68, 128, 13, 90}, {-90, 130, 15, 90},      // A5 - H5
    {77, 106, 5, 90}, {52, 104, 5, 90}, {29, 100, 0, 90}, {6, 100, 2, 90}, {-13, 96, 0, 90}, {-35, 96, 3, 90}, {-60, 100, 5, 90}, {-83, 100, 11, 90},               // A6 - H6
    {73, 78, 5, 90},   {50, 72, 0, 90},   {26, 70, 0, 90},   {8, 70, 0, 90},   {-10, 70, 0, 90},    {-29, 70, 0, 90},   {-52, 72, 2, 90},   {-79, 76, 5, 90},       // A7 - H7
    {80, 60, 22, 90},  {55, 58, 15, 90},  {32, 55, 15, 90},  {10, 55, 12, 90},  {-8, 58, 14, 90},  {-30, 55, 12, 90},  {-54, 64, 15, 90},  {-80, 60, 28, 90}        // A8 - H8  // Solo funciona bien con q2 de caida en 0
};
...
int Tiempo_para_velocidad_servo_rapida = 20 ;       // Declaro una variable de tipo int para el tiempo de movimiento rápido del servo. Poner 40 para movimientos rápidos.(con 10 funciona perfecto, aunque no tan rapido)
